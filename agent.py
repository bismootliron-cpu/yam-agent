...
CAPABILITIES = {
    ...
    "full_video": {
        ...
        "fields": {"image_prompt", "library_tag", "voiceover_text", "duration", "effects", "music_library_tag", "image_description"},
        "optional_sections": ["---OVERLAY LINES---"],
    },
    "edit_video": {
        "description": "Trim / speed-ramp / caption / re-voice ONE real video clip.",
        "fields": {"library_tag", "trim_start", "duration", "speed_ramp_at", "speed_multiplier", "voiceover_text", "effects", "music_library_tag", "image_description"},
        "optional_sections": ["---OVERLAY LINES---"],
    },
    "multi_scene_video": {
        ...
        "fields": {"voiceover_text", "effects", "disclaimer", "music_library_tag",
                   "library_tag", "duration", "zoom", "text", "text_delay", "image_description", "transition", "fit"},
    ...
    "multi_clip_video": {
        ...
        "fields": {"voiceover_text", "effects", "disclaimer", "music_library_tag",
                   ...
                   "library_tag", "trim_start", "duration", "text", "text_delay", "image_description"},
...
def _handle_multi_scene_video(fields: dict, body: str, report) -> str:
    ...
    for chunk in scene_chunks:
        ...
        scenes.append({
            "image_url": image_url,
            "duration": duration,
            "fit": scene_fields.get("fit", "").strip().lower() or "cover",
